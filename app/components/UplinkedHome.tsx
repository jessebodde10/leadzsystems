      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-[var(--ul-line)] bg-white/80 backdrop-blur-md">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <a href="#top" className="flex items-center">
            <Image src="/logo.png" alt="Leadz Systems" width={1350} height={157} className="h-[28px] w-auto object-contain" priority unoptimized />
          </a>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-[1.4fr_1fr_1fr]">
          <div>
            <div className="flex items-center">
              <Image src="/logo.png" alt="Leadz Systems" width={1350} height={157} className="h-[28px] w-auto object-contain" unoptimized />
            </div>
