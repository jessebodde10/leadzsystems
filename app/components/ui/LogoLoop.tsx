...
// React Bits — LogoLoop. CSS lives in HeroConcept's scoped style block (.logoloop*).

type LogoNodeItem = { node: ReactNode; title?: string; href?: string; ariaLabel?: string };
type LogoImageItem = { src: string; alt?: string; title?: string; href?: string; width?: number; height?: number; srcSet?: string; sizes?: string };
